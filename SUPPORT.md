...
There is no guaranteed response time. Do not rely on issue support during a live event; test before doors open and keep an operational fallback.

Security vulnerabilities must use GitHub private vulnerability reporting, not public issues or Discussions.
